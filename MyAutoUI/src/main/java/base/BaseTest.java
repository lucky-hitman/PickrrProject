...
public class BaseTest {
    ...
    public void init(Method m) {
        Reporter.setExtentTest(m.getName());
    }
    ...
    public void tearDown(ITestResult result) {
        try {
            if (result.getStatus() == ITestResult.SUCCESS) {
                ...
                Reporter.setTestStatus(Status.PASS, "Test case execution status is SUCCESS", result.getName());
            } else if (result.getStatus() == ITestResult.FAILURE) {
                // Do something here
                System.out.println("Test case execution status is FAILURE");
                Reporter.setTestStatus(Status.FAIL, "Test case execution status is FAILURE", result.getName());
            } else if (result.getStatus() == ITestResult.SKIP) {
                System.out.println("Test case execution status is SKIP");
                Reporter.setTestStatus(Status.SKIP, "Test case execution status is SKIP", result.getName());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
